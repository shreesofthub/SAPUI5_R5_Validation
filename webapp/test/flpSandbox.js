		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Do validation - Mandatory,data validations",
									"targetURL": "#r5validation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"r5validation-display": {
								"semanticObject": "r5validation",
								"action": "display",
								"description": "Do validation - Mandatory,data validations",
								"title": "Do validation - Mandatory,data validations",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=r5validation",
									"url": sap.ui.require.toUrl("r5validation")
								}
							}
						}
					}
